...
public class RigaDocumentoForm extends Sequence {
    ...
    public static String[] listaCampiHidden = {
            "tipologia", "iddocumento" };
    public static String[] listaCampiForm = {
            "idTipoDoc", "profiloautoredoc", "profilodescrizionedoc" };
    public static String[] listaCampiFormPrinc = {
            "idTipoDoc", "profiloautoredoc", "profilodescrizionedoc", "cdVersioneXSD" };

    /**
     *
     */
    public RigaDocumentoForm(DefaultSelectionProvider selTipoDoc,
            DefaultSelectionProvider selCDVersione, DefaultSelectionProvider selTipoStrutDoc,
            String nomeFieldset, Mode mode, String prefix, boolean isPrincipale) {
        elfoHidden = new FormBuilder(ParDocumento.class).configFields(listaCampiHidden)
                .configMode(Mode.HIDDEN).configPrefix(prefix).build();
        if (isPrincipale)
