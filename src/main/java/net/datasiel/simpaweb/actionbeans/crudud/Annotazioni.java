 ...
 *
 */
@UrlBinding("/pro/annota/{idrecord}")
@InfoToolbar(titolo = "Annotazioni", accelerator = "T", breadcrumbs = "Home")
public class Annotazioni extends Documenti {
