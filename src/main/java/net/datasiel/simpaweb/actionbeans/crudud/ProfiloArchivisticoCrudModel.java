...
/**
 * Sarà composto così: intestazioneRO: intestazione (cambiando solo il tipo da FormUnitaDoc a quello
 * vero intestazioneRW: oggetto corrispondente a fascicolo principale (ParFascicolo) righe: lista di
 * fascicoli secondari (List<RigaModel>).
 *
 * @author reisoli
 *
 */
