...
public class VDecTipoDoc implements Serializable {
    ...
    /**
     * Type : VARCHAR Name : NM_TIPO_DOC
     */
    public String nmTipoDoc;

    /**
     * Type : VARCHAR Name : DS_TIPO_DOC
     */
    public String dsTipoDoc;

    /**
     * Type : CHAR(1) Name : FL_TIPO_DOC_PRINCIPALE
     */
    public String flTipoDocPrincipale;
    ...
    /**
     * Sets the value for flTipoDocPrincipale
     */
    ...
    /**
     * Gets the value for flTipoDocPrincipale
     */
    @Required
    @MaxLength(1)
    public String getFlTipoDocPrincipale() {
        return flTipoDocPrincipale;
    }
