...
/**
 * Elenca le possibiili tipologie di documenti con la relativa dicitura leggibile per le diverse ed
 * il relativo valore inserito in DB per individuare le tipologie documentarie ammesse.
 *
 * @author reisoli
 *
 */
public enum EnumTipoDocumento {
    PRINC("documento principale", "PRINCIPALE"), ALLE("allegato", "ALLEGATO"),
    ANNE("annesso", "ANNESSO"), ANNO("annotazione", "ANNOTAZIONE");
