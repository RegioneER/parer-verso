...
public class SLLogLoginUserDAO extends SLLogLoginUser {
    ...
    static {
        fieldNames = new String[] {
                "idLoginUser", "idApplic", "nmUserid", "cdIndIpClient", "cdIndServer", "tipoEvento",
    ...
    public int insertPrepared(SLLogLoginUser obj, Connection con) throws SQLException {
        int indice = 1;
        String prepQuery = "Insert into sacer_log.LOG_LOGIN_USER ("
                + "ID_LOGIN_USER,ID_APPLIC,NM_USERID,"
