...
public class FreeLayoutNumericFieldHelper implements FieldHelper {
     ...
     * (com.manydesigns.elements.reflection.ClassAccessor,
     * com.manydesigns.elements.reflection.PropertyAccessor, com.manydesigns.elements.Mode,
     * java.lang.String)
     */
    public Field tryToInstantiateField(ClassAccessor classAccessor,
            PropertyAccessor propertyAccessor, Mode mode, String prefix) {
     ...
     * (com.manydesigns.elements.reflection.ClassAccessor,
     * com.manydesigns.elements.reflection.PropertyAccessor, java.lang.String)
     */
    public SearchField tryToInstantiateSearchField(ClassAccessor classAccessor,
            PropertyAccessor propertyAccessor, String prefix) {
        Class<?> type = propertyAccessor.getType();
        if (Util.isNumericType(type)) {
