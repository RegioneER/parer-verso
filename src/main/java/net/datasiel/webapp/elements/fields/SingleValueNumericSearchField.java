...
public class SingleValueNumericSearchField extends AbstractSearchField {
     ...
     *
     * @param accessor L'accessor del campo
     */
     ...
     *
     * @param accessor L'accessor del campo
     * @param prefix   Il prefisso delle tavole da aggiungere alla query
     */
     ...
     *
     * @param criteria L'oggetto criteria da configurare
     */
    ...
    /**
     * @see com.manydesigns.elements.fields.search.SearchField#toSearchString(java
     *      .lang.StringBuilder)
     *
     * @param sb String buffer della query
     */
     ...
     *
     * @see com.manydesigns.elements.xml.XhtmlFragment#toXhtml(
     *      com.manydesigns.elements.xml.XhtmlBuffer)
     *
     * @param xb XhtmlBuffer a cui aggiungere il campo
     */
