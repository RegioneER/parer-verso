...
@XmlType(name = "DatiSpecificiTypeUD", propOrder = {
        "versioneDatiSpecifici", "denominazioneBando", "ragioneSociale", "dataPresentazione",
        "importoTotaleLordo", "contributoRichiesto" })
