...
@XmlType(name = "SottoComponenteType", propOrder = { "id", "ordinePresentazione", "tipoComponente",
        "tipoSupportoComponente", "riferimento", "nomeComponente", "formatoFileVersato", "urnVersato",
        "idComponenteVersato", "datiSpecifici", "datiSpecificiMigrazione" })
