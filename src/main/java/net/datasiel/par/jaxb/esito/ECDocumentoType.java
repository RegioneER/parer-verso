...
@XmlType(name = "ECDocumentoType", propOrder = {
        "chiaveDoc", "idDocumento", "tipoDocumento", "firmatoDigitalmente", "esitoDocumento",
        "componenti" })
public class ECDocumentoType {
     ...
     *
     * @param value allowed object is {@link ECDocumentoType.EsitoDocumento }
     *
     */
     ...
     *
     * @param value allowed object is {@link ECDocumentoType.Componenti }
     *
     */
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = {
            "codiceEsito", "verificaTipoDocumento", "corrispondenzaDatiSpecifici",
            "corrispondenzaDatiFiscali", "numerazioneFiscale", "verificaTipoStruttura",
            "verificaFirmeDocumento", "univocitaOrdinePresentazione" })
