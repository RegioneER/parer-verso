...
@XmlType(name = "ECMarcaType", propOrder = {
        "ordineMarca", "formatoMarca", "timestamp", "esitoMarca" })
public class ECMarcaType {
     ...
     *
     * @param value allowed object is {@link ECMarcaType.EsitoMarca }
     *
     */
    ...
    @XmlType(name = "", propOrder = {
            "controlloConformita", "verificaMarca" })
    public static class EsitoMarca {
         ...
         *
         * @param value allowed object is {@link ECMarcaType.EsitoMarca.VerificaMarca }
         *
         */
