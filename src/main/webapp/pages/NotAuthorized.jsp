			...
			<div class="offset3 span6">
				<div class="well well-large">
	                ...
	                <ul>
	                    ...
	                    Utente non autorizzato. <stripes:link beanclass="net.datasiel.simpaweb.actionbeans.Logout"><i class="icon-off" style="color: #2F96B4"></i>Effettua il logout.</stripes:link>
	                    </li>
                        </c:if>
                        <c:if test="${messaggio eq null}">
	                    <li class="message  info  ">
                                <%=messaggio%> <stripes:link beanclass="net.datasiel.simpaweb.actionbeans.Login"><i class="icon-off" style="color: #2F96B4"></i>Effettua di nuovo il login.</stripes:link>
	                    </li>
                        </c:if>
	                </ul>
