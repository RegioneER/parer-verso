...
<%-- 	uri = "http://shiro.apache.org/tags" prefix="shiro"%> --%>
	<%@ page
	import="net.datasiel.webapp.InfoToolbar"%><%@page 
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" media="screen" type="text/css" href="<c:url value="/css/bootstrap-accessibility.css"/>" />		
	...
	<%
							...
							try {
								com.manydesigns.elements.forms.Form enteStruttura = (com.manydesigns.elements.forms.Form)(((net.datasiel.simpaweb.actionbeans.HomePrivata)actionBean).getEnteStruttura());
						...
						<div class="span5" >
							<ul class="nav nav-pills pull-right">
								...
								<ul class="dropdown-menu">
									...
									<li>
										<stripes:link beanclass="net.datasiel.simpaweb.actionbeans.GestionePassword">
											<stripes:param name="idStrut" value="${actionBean.idStrut}"></stripes:param>
											<stripes:param name="azione" value="gestione"></stripes:param>
											Dati Versatore 
										</stripes:link>
									</li>
								</ul>
				...
				<div class="row-fluid" >
					<div class="offset3 span6" >
						  <div class="well well-large">
							  ...
							  <img alt="Logo Applicazione" src="<c:url value='/img/Logo-SACER-VERSO_Beta.png' />" alt="">
